export const ModalStyles = {
    ...
    container: "bg-white rounded-lg shadow-lg mx-4 my-2 mt-10 flex flex-col relative pt-6 border-4 border-white overflow-hidden max-h-[80vh] w-11/12 sm:w-[70vw]",
        header: {
      ...
      container: "overflow-y-auto overflow-x-hidden flex-1 min-h-0 sm:mx-5 sm:m-0 m-2 sm:bg-transparent bg-white sm:rounded-none rounded-xl"
        },
